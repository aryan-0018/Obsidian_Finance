        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-12 bg-[#0f0f0f] text-center border-l border-[#2a2520]">
          <div className="w-full max-w-2xl flex flex-col items-center space-y-8">
            <h1 className="text-4xl md:text-5xl font-light text-[#e8e0d4] tracking-tight leading-tight">
              Elevate your <span className="text-[#c1a063] font-medium italic">wealth</span> management.
            </h1>
            <p className="text-lg md:text-xl text-[#9a9080] font-light max-w-xl leading-relaxed">
              ObsidianFinance delivers unparalleled financial clarity, elite analytics, and effortless control over your legacy. Crafted for those who demand excellence.
            </p>

            <div className="grid grid-cols-2 gap-8 mt-12 w-full max-w-lg text-left">
              <div className="border-l-2 border-[#c1a063]/40 pl-4">
                <h3 className="text-[#c1a063] font-medium mb-1">Elite Insights</h3>
                <p className="text-[#9a9080] text-sm">AI-driven financial intelligence.</p>
              </div>
              <div className="border-l-2 border-[#c1a063]/40 pl-4">
                <h3 className="text-[#c1a063] font-medium mb-1">Absolute Control</h3>
                <p className="text-[#9a9080] text-sm">Your portfolio, masterfully organized.</p>
              </div>
            </div>
          </div>
        </div>
